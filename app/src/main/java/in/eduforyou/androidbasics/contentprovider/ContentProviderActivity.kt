package `in`.eduforyou.androidbasics.contentprovider
...
class ContentProviderActivity : AppCompatActivity() {
    ...
    fun onClickShowDetails(view: View?) {
        ...
        // content URI
        val cursor = contentResolver.query(Uri.parse("content://in.eduforyou.androidbasics.provider/users"), null, null, null, null)
